...
<nav class="fixed top-0 left-0 right-0 z-50 bg-dark-950/80 backdrop-blur-xl border-b border-white/5" x-data="{ mobileOpen: false, profileOpen: false }">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
            ...
            <div class="hidden md:flex items-center space-x-6">
                ...
                <a href="{{ route('user.dashboard') }}" class="text-sm text-gray-400 hover:text-white transition-colors">Dashboard</a>
                <a href="#" class="text-sm text-gray-400 hover:text-white transition-colors">Bookmarks</a>
                <a href="#" class="text-sm text-gray-400 hover:text-white transition-colors">History</a>
                <a href="#" class="text-sm text-gray-400 hover:text-white transition-colors">API</a>
                <a href="{{ route('user.player') }}" class="text-sm text-gray-400 hover:text-white transition-colors">XapiPlay</a>
            ...
            <div class="flex items-center space-x-4">
                ...
                <div class="relative" @click.away="profileOpen = false">
                    ...
                    <div x-show="profileOpen" x-cloak x-transition:enter="transition ease-out duration-100" x-transition:enter-start="opacity-0 scale-95" x-transition:enter-end="opacity-100 scale-100" x-transition:leave="transition ease-in duration-75" x-transition:leave-start="opacity-100 scale-100" x-transition:leave-end="opacity-0 scale-95"
                        ...
                        <a href="{{ route('user.dashboard') }}" class="flex items-center px-4 py-2 text-sm text-gray-400 hover:text-white hover:bg-white/5 transition-colors">
    ...
    <div x-show="mobileOpen" x-cloak x-transition class="md:hidden bg-dark-900 border-t border-white/5">
        <div class="px-4 py-3 space-y-1">
            ...
            <a href="{{ route('user.dashboard') }}" class="block px-3 py-2 text-sm text-gray-400 hover:text-white rounded-lg hover:bg-white/5">Dashboard</a>
            ...
            <a href="{{ route('user.player') }}" class="block px-3 py-2 text-sm text-gray-400 hover:text-white rounded-lg hover:bg-white/5">XapiPlay</a>
